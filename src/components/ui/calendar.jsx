    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-6 w-6 p-0 font-normal aria-selected:opacity-100 text-[10px]"
        ),
        ...
        dropdown: "text-[10px] border border-gray-200 rounded px-1 py-0.5 bg-white cursor-pointer focus:outline-none focus:border-[#1E40AF]",
        vhidden: "hidden",
        ...classNames,
      }}
      components={{
